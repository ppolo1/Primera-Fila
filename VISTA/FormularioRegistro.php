            ...
            <form id="formularioRegistro" novalidate>
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="nombre" placeholder="Obligatorio">
                        <span id="errorNombre"></span>
                    </div>
                    <div class="col-md-4">
                        <label for="apellido1" class="form-label">Primer Apellido:</label>
                        <input type="text" class="form-control" id="apellido" placeholder="Obligatorio">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" class="form-control" id="contrasena" placeholder="Obligatorio">
                        <div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" class="form-control" id="confirmarContrasena" placeholder="Obligatorio">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="telefonoInput" placeholder="telefono">
                    </div>
                    <div class="col-md-6">
                        <label for="email" class="form-label">Email:</label>
                        <input type="email" class="form-control" id="emailInput" placeholder="Obligatorio">
                        <span id="errorEmail"></span>
                    </div>
                    <div class="col-12">
                        <label>
                            <input type="checkbox" class="form-check-input" id="subscripcionInput">
                            Subscribirse
                        </label>
                    </div>
                </div>
