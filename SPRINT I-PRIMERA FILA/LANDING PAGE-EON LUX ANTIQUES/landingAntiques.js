...
function mostrarOcultarDNI() {
    ...
    if (paisSelect.value === "ES") {
        ...
        // Limpiar el campo DNI y los mensajes de error
        dni.value = "";
        errorDni.innerHTML = "";
    }
}
...
function validarDNI() {
    ...
    if (paisSelect.value !== "ES") {
        // Si el país no es España, considera el DNI como válido para que permita envíar el formulario
        return true;
    }
...
function validarFormulario() {
    ...
    if ((DNIValido || nombreValido) && (fechaNacimientoPresente ? fechaValida : true) && confirmacionContrasenaValida && contrasenaValida && emailValido) {
